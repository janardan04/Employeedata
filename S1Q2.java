...
// To Compile: javac -cp ".;postgresql-42.7.1.jar" S1Q2.java
// To Run: java -cp ".;postgresql-42.7.1.jar" S1Q2.java

// Note :- Do NOT change any of the LAYOUTs it'll not work trust me I've tried :)
    ...
    public void saveEmployeeDetails() {
        ...
        try {
            ...
            if (rowsAffected > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Failed to save employee details", "Error", JOptionPane.ERROR_MESSAGE);
            }
